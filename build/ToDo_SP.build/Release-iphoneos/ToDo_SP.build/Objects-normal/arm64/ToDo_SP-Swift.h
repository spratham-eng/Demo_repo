...
#ifndef TODO_SP_SWIFT_H
#define TODO_SP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ToDo_SP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ToDo_SP11AppDelegate")
...
SWIFT_CLASS("_TtC7ToDo_SP13SceneDelegate")
...
SWIFT_CLASS("_TtC7ToDo_SP14ViewController")
